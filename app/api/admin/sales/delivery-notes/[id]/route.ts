// app/api/admin/sales/delivery-notes/[id]/route.ts
...
// GET /api/admin/sales/delivery-notes/[id]
...
// PATCH /api/admin/sales/delivery-notes/[id]
...
// DELETE /api/admin/sales/delivery-notes/[id]
