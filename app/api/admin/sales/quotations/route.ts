...
// ── GET /api/admin/sales/quotations ──────────────────────────────────────────
export const GET = await makeListHandler("QUOTATION");

// ── POST /api/admin/sales/quotations ─────────────────────────────────────────
export async function POST(req: NextRequest) {
  try {
    ...
    const { customerId, marketId, lines, subject, referenceNumber,
            ...
            issueDate, dueDate, validUntil, originDocId } = body;
    ...
    const doc = await createDocument({
      ...
      issueDate, dueDate, validUntil, originDocId,
      lines,
    });
