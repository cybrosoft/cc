...
export async function POST(req: Request) {
  try {
    ...
    const { slug, name, family, description, category, iconType, iconValue,
    ...
    if (isDefault === true && family) {
      await prisma.osTemplate.updateMany({ where: { family, isDefault: true }, data: { isDefault: false } });
    }
