...
// Lists the customer's Security subscriptions — any product tagged "security"
// (SSL, WAF, DDoS protection, scanning, VPN, etc.)
  ...
  try {
    ...
    const data = subscriptions.map(sub => {
      ...
      return {
        ...
        type:            sub.product.category?.name ?? "—",
        resourceName,
