...
// Customer notification preferences — opt out of marketing per channel,
// set DND hours for SMS, manage timezone.
"use client";
    ...
    <div style={{
      ...
      <div style={{ ...card, background: "#f9fafb" }}>
        <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.6 }}>
          ...
          <a href="mailto:support@cybrosoft.com" style={{ color: P, marginLeft: 4 }}>support@cybrosoft.com</a>.
        </p>
      </div>
