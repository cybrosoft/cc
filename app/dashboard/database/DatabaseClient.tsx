"use client";
// app/dashboard/database/DatabaseClient.tsx
...
const COLS = ["Name", "Instance ID", "State", "Engine", "Connection Host", "Specs", "Storage", "Location", "Created", "Payment", "Actions"];
    ...
    <div className="cy-page-content">
      <div className="cy-dash-wrap">
        ...
        <div style={{ marginBottom: 8 }}>
          <p style={{ fontSize: 11, color: C.faint, letterSpacing: ".05em", margin: "0 0 4px" }}>DASHBOARD / DATABASE</p>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <h1 style={{ fontSize: 22, fontWeight: 700, color: C.text, margin: 0 }}>Database</h1>
        ...
        <p style={{ fontSize: 13, color: C.faint, margin: "0 0 16px" }}>0 databases</p>
