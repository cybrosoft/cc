"use client";
// app/dashboard/aai/AaiClient.tsx
...
const COLS = ["Name", "Resource ID", "State", "Category", "Specs", "Location", "Created", "Payment", "Actions"];

export function AaiClient() {
  return (
    <div className="cy-page-content">
      <div className="cy-dash-wrap">
        ...
        <div style={{ marginBottom: 8 }}>
          <p style={{ fontSize: 11, color: C.faint, letterSpacing: ".05em", margin: "0 0 4px" }}>DASHBOARD / ANALYTICS &amp; AI</p>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
            <h1 style={{ fontSize: 22, fontWeight: 700, color: C.text, margin: 0 }}>Analytics &amp; AI</h1>
        ...
        <p style={{ fontSize: 13, color: C.faint, margin: "0 0 16px" }}>0 resources</p>
            ...
            <tbody>
              <tr>
                <td colSpan={COLS.length} style={{ padding: "32px 16px", textAlign: "center", fontSize: 13, color: C.faint }}>
                  No analytics or AI resources yet.
                </td>
              </tr>
            </tbody>
          </table>
