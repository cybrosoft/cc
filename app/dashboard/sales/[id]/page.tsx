...
export default async function SalesDocPage({
  ...
  const legalInfo  = doc.market.legalInfo as Record<string, any> | null;
  ...
  const serialized = {
    ...
    market: {
      ...
      bankDetails:    legalInfo?.bankDetails     ?? null,
      paymentMethods: (doc.market.paymentMethods ?? []) as string[],
    },
    customer: {
